...
| **Tests**                  | 714 unit tests (Vitest), including the runtime plan, generated shell parsed by a real `sh -n`, portable backup, VPS preflight, Ansible YAML, and safety paths |
