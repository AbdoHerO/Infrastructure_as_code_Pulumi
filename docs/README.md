...
| **Tests**                  | 724 unit tests (Vitest), including cross-feature runtime synchronization, generated shell parsed by a real `sh -n`, portable backup, VPS preflight, Ansible YAML, and safety paths |
